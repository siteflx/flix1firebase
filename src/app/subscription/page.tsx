      ...
      <main className="flex-1 p-4 py-8 md:p-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center px-2">
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Nossos Planos de Assinatura</h1>
          ...
          <div className="mt-12 w-full">
             <div className="grid grid-cols-1 place-items-center gap-6 sm:grid-cols-2 sm:place-items-stretch sm:gap-6 md:grid-cols-3 md:gap-8">
              {plans.map((plan) => (
                <Card
                  key={plan.name}
                  className={cn(
